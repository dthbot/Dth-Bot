...
let handler = async (m, { conn, text }) => {
    ...
    if (!txt) throw '🚩 𝚒𝚗𝚜𝚎𝚛𝚒𝚜𝚌𝚒 𝚕𝚊 𝚚𝚞𝚊𝚗𝚝𝚒𝚝𝚊 𝚍𝚒 *💶 Euro* 𝚍𝚊 𝚝𝚛𝚊𝚜𝚏𝚎𝚛𝚒𝚛𝚎'
    ...
    if (costo > users[m.sender].limit) throw '𝚗𝚘𝚗 𝚑𝚊𝚒 𝚊𝚋𝚋𝚊𝚜𝚝𝚊𝚗𝚣𝚊 *💶 Euro* 𝚙𝚎𝚛 𝚚𝚞𝚎𝚜𝚝𝚘 𝚝𝚛𝚊𝚜𝚏𝚎𝚛𝚒𝚖𝚎𝚗𝚝𝚘'
    
    // Esegui la transazione
    users[m.sender].limit -= costo
    users[who].limit += Unitycoins
    
    await m.reply(`*${-Unitycoins}* 💶 Euro 
𝚝𝚊𝚜𝚜𝚊 2% : *${-tassaImporto}* 💶 𝚝𝚊𝚜𝚜𝚊 𝚒𝚖𝚙𝚘𝚛𝚝o
𝚝𝚘𝚝𝚊𝚕𝚎 𝚊𝚍𝚍𝚎𝚋𝚒𝚝𝚘: *${-costo}* 💶 Euro`)
    
    // Notifica il destinatario
    conn.fakeReply(m.chat, `*+${Unitycoins}* *💶 Euro*  𝚛𝚒𝚌𝚎𝚟𝚞𝚝𝚎!`, who, m.text)
}
